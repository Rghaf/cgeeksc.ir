...
class PostFieldsMixin(): 
    def dispatch(self, request, *args, **kwargs):
        if request.user.profile.is_admin:
            self.fields = ['title', 'slug', 'content', 'image', 'summary', 'category', 'user',  'status', 'file_url', 'youtube_url', 'refrence']
        elif request.user.profile.is_author:
            self.fields = ['title', 'slug', 'content', 'image', 'summary', 'category', 'file_url', 'youtube_url', 'refrence']
        else:
